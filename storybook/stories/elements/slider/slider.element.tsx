...
export default class Slider extends PureComponent<SliderProps, any> {
    ...
    render() {
        ...
        const mainStyles: any = styles || defaultStyles;
    ...
    _getCurrentValue = () => (this.state.value as any).__getValue();
    ...
    _setCurrentValueAnimated = (value: number) => {
        ...
        (Animated[animationType] as any)(this.state.value, animationConfig).start();
    };
...
export interface SliderProps {
    ...
    styles: ViewStyle | ViewStyle[] | RegisteredStyle<ViewStyle | ImageStyle | TextStyle> | RegisteredStyle<ViewStyle | ImageStyle | TextStyle>[]

    /**
     * The style applied to the track.
     */
    trackStyle: ViewStyle | ViewStyle[] | RegisteredStyle<ViewStyle | ImageStyle | TextStyle> | RegisteredStyle<ViewStyle | ImageStyle | TextStyle>[],

    /**
     * The style applied to the thumb.
     */
    thumbStyle: ViewStyle | ViewStyle[] | RegisteredStyle<ViewStyle | ImageStyle | TextStyle> | RegisteredStyle<ViewStyle | ImageStyle | TextStyle>[],
